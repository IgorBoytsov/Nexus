...
namespace Nexus.UserManagement.Service.Application.Interfaces.Repositories
{
    ...
    {
        Task<Shared.Contracts.UserManagement.Responses.UserAuthDataResponse> GetUserByIdAuth(Guid userId);
        Task<Shared.Contracts.UserManagement.Responses.UserAuthDataResponse> GetUserByLoginAuth(string login);
